...
function result() {
    ...
    function result() {
        ...
        // Perform the desired result checking here
        let isResultCorrect = correct >= 10;
      ...
      function main() {
        ...
        // Wait for the timer or the user to enter 10 words
        // Assuming you have some event or condition to check if the user has typed at least 10 words
        // You can modify this part based on your specific implementation
        while (new Date().getTime() - startTime < 30000 && !showedResult) {
          // Check if the user has typed at least 10 words
   ...
   alert("You did not enter at least 10 words before the timer ran out.")
          }
        }
        }
      main();
    ...
    if (words<10) {accuracy = Math.round((net / gross)*50)
        
    } else {accuracy = Math.round((net / gross)*100)
